...
async function filtrarDatos() {
  ...
  try {
    ...
    if (mensaje.classList.contains("display-none") && periodosSelect.value == "Año" || cargosSelect.value == "Cargo" || seccionSelect.value == "" || distritosSelect.value == "Distrito"){
